hivepress.initGeolocation2 = function() {
	(function($) {
		'use strict';
		...
		$(document).ready(function() {
			...
			// destination
			hivepress.getComponent('destination').each(function() {
				var container = $(this),
			...
			// Map
			hivepress.getComponent('map2').each(function() {
				var container = $(this),
					prevWindow = false,
					markers = [],
				...
				var clusterer = new MarkerClusterer2(map, markers, {
